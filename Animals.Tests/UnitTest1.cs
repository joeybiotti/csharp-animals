...
namespace Animals.Tests
{
    public class AnimalShould
    {
        ...
        [Fact]
        public void SetSpeciesMethodShoudlSetSpeciesProperty()
        {
        ...
        [Fact]
        public void HaveWalkingSpeedWithWalkMethod()
        {
            _animal.Walk(30);
        ...
        [Fact]
        public void InstaceShouldBeOfCorrectType()
        {
